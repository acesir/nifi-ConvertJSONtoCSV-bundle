...
public class ConvertJSONtoCSV extends AbstractProcessor {
    ...
    public static final PropertyDescriptor REMOVE_FIELDS = new PropertyDescriptor
            ...
            .description("Comma delimited list of columns that should be removed when parsing JSON and building the CSV. This includes all top level and most granular nested fields/columns. By default with nothing specified every field will be parsed.")
            .required(false)
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build();
    ...
    public static final PropertyDescriptor EMPTY_FIELDS = new PropertyDescriptor
            ...
            .description("During denormalization/flattening of the JSON the value that will be substituted for empty fields values (Example: NULL). Defaults to empty string if not specified.")
            .required(false)
            .addValidator(StandardValidators.NON_EMPTY_VALIDATOR)
            .build();
