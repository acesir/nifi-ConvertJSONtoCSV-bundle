 ...
 */
package org.apache.nifi.processors.ConvertJSONtoCSV;
...
public class TestConvertJSONtoCSV {
    ...
    public void testTweetMultiNestedJSON() throws IOException {
        ...
        runner.enqueue(Paths.get("src/test/resources/tweet.json"));
        runner.run();
        runner.assertAllFlowFilesTransferred(ConvertJSONtoCSV.RELATIONSHIP_SUCCESS);

        final MockFlowFile out = runner.getFlowFilesForRelationship(ConvertJSONtoCSV.RELATIONSHIP_SUCCESS).get(0);
        out.assertContentEquals(new String(Files.readAllBytes(Paths.get("src/test/resources/tweet.csv"))));
    }
    ...
    public void testMalformedJSON() throws IOException {
        ...
        runner.enqueue(Paths.get("src/test/resources/simpleMalformed.json"));
        runner.run();
    ...
    public void testNonJSON() throws IOException {
        ...
        runner.enqueue(Paths.get("src/test/resources/simple.csv"));
        runner.run();
        runner.assertAllFlowFilesTransferred(ConvertJSONtoCSV.RELATIONSHIP_FAILURE);
    }
    ...
    public void testJSONObject() throws IOException{
        ...
        runner.enqueue(Paths.get("src/test/resources/object.json"));
        runner.run();
        runner.assertAllFlowFilesTransferred(ConvertJSONtoCSV.RELATIONSHIP_SUCCESS);

        final MockFlowFile out = runner.getFlowFilesForRelationship(ConvertJSONtoCSV.RELATIONSHIP_SUCCESS).get(0);
        out.assertContentEquals(new String(Files.readAllBytes(Paths.get("src/test/resources/object.csv"))));
    }
